...
| B | `4a2cf724` (main after #1342 — the structural block: #922 #559 #377 #381 #1241 #154 #218 #219) **+ the #1350 and #1352 instrument fixes cherry-picked**, so the checkpoint still isolates the structural block from the behavioural one | `TBD` | the checkpoint pair | *pending* |
