...
- **Amendment (2026-09-09, with the 1.7.5 plan)** — the 1.7.5 row the 2026-09-05 amendment
  ...
  #637, #1152 with #1443 — the correction runner, filed with that plan's rev 2 — and #1149
  first); the extractions and test items as a CI list (#929/#1206, #198, #580, #1182, #1180,
  #1178, #353, #579, #176); **#567 re-placed to the 1.8 rider** at rev 2; #1444 (the qa/dev
  `handle()` split) placed as 1.8's first extraction; #1177 as the ops rider; #330, #372,
