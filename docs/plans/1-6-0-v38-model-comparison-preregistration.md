...
| Deploy — commit + 7 image ids | **`5d66f80f`** (2026-08-20 rebuild; delta vs V7's `61a12e38` = #1005 instrument fix + `full-38` profile + docs, per §2.5); runtime-api `fd5983debad8`; max `b8f3a4b09859`; neo `fcfaf9ac7b5b`; nat `cdb25f26e4fc`; bob `8ce447c5eb91`; eve `3203201b0a91`; data `038a9f781345`. #1005 concat fix verified on the loaded runtime-api module; `full-38`→`qwen3.8:27b` verified in the baked config; PRD sha + config hash re-verified unchanged |
