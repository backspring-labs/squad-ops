...
| 3 | **Cycle Evaluation Scorecard — phases 1+2 only** — evaluation contract + evidence capture; defer console UI to post-1.0 | proposed, needs scope cut | `sips/accepted/SIP-0108-Cycle-Evaluation-Scorecard.md` | — |
