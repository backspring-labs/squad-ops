...
|---|---|---|---|
| 4 | 2026-08-26 | E moves `squad_profile_snapshot_ref`, not `resolved_config_hash` (rev 2 was wrong; corrected from the first shakeout's launch line). Both shakeout pairs recorded; stack #1 arm found #1120 (fixed, #1121); #1122/#1123 filed for the targeted-repair rungs | `cyc_0e81955001e0` launch line; `cycle_registry.squad_profile_snapshot_ref`; `cyc_3cde35fa5204` runtime-api log |
