...
- Created: 2026-02-27
- Target Release: 1.1+ — **superseded 2026-09-13**: the proposal this idea became, SIP-0108 (`sips/accepted/SIP-0108-Cycle-Evaluation-Scorecard.md`, accepted 2026-09-13), targets v1.8 as its Lane S headline, with a narrower, mechanical slice. This document stays the source of the philosophy.
- Owner: SquadOps Core
