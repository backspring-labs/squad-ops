...
### v1.5.0 (2026-08-06) — Current — Finish the Promises, Extract the Proven (stabilization)
...
- **SIPs**: 64 implemented, 7 accepted (SIP-0088, 0090–0093, 0101, 0102), 20 deprecated (registry)
- **Tests**: 6,400+ passing in the regression suite
