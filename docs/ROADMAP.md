...
| **SIP-0108** | Cycle Evaluation Scorecard | **the 1.8 Lane S headline** — accepted at its design review 2026-09-13 with required revision (rev 3); the four slice deliverables in the 1.8 plan §3.4, (a) and (b) non-droppable; the comparison's generalist arm defined in its §4.4 |
