...
*Re-read 2026-09-12 with the 1.8 plan (`docs/plans/1-8-0-plan.md` §6); none of these but SIP-0107 is 1.8 work, and the 1.7.5 cut's sweep left every earlier one `accepted` with its gap named. SIP-0107 was accepted 2026-09-13.*
...
| **SIP-0107** | Scoped Code Revision | **the 1.8 Lane M headline** — accepted at its design review 2026-09-13 with required revision (rev 4), on main when PR #1325 merges; rolled out by the 1.8 plan §3.3, #1444 first |
...
*As of 2026-09-12 (v1.7.5):*

- **Framework version**: 1.7.5
- **SIPs**: 66 implemented, 9 accepted (SIP-0088, 0090–0093, 0101, 0102, 0104, 0105), 20 deprecated (registry)
- **Tests**: 10,000+ passing in the regression suite (all of `tests/unit`, #1316)
- **Python source**: ~103,000 lines measured 2026-09-12 (`src/` ~79,000 + `adapters/` ~24,000; ~159,000 test lines; ~139,000 lines of Markdown under `docs/` and `sips/`)
