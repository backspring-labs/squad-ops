...
- **v1.4** — **the Verified Canonical App Build** (revised 2026-07-14): verification evidence integrity (SIP-0096) + the golden-path pair — Ephemeral Application Sandbox (`sips/proposed/SIP-Externalized-Build-Sandbox.md`, Lane S) + Contract-First Build Scaffolding (Lane M). Cut gate: ≥2 consecutive golden-benchmark runs reaching a verified functional outcome with zero manual intervention. SIP-0091 and SIP-0090 P2 moved to 1.6. Plan: `docs/plans/1-4-evidence-arc-plan.md`; strategy: `docs/ideas/IDEA-Functional-App-Obstacles-and-Roadmap.md`.
