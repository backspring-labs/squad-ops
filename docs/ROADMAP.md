...
*Re-read 2026-09-12 with the 1.8 plan (`docs/plans/1-8-0-plan.md` §6); none of these is 1.8 work, and the 1.7.5 cut's sweep left every one `accepted` with its gap named.*
...
| SIP | Title |
|-----|-------|
| (unnumbered, PR #1325, unmerged) | Scoped Code Revision (the 1.8 Lane M headline by the owner's ruling 2026-09-09; its design review is the 1.8 plan's opening step) |
