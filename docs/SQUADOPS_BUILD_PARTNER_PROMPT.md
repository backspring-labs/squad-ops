...
- **docs/SQUADOPS_CONTEXT_HANDOFF.md** - Complete system overview, protocols, architecture, and current status
...
*For detailed agent specifications, reasoning styles, and capabilities, see docs/SQUADOPS_CONTEXT_HANDOFF.md*

## 🔄 **Core Protocols**

*For detailed protocol specifications, see docs/SQUADOPS_CONTEXT_HANDOFF.md*
...
*For detailed infrastructure specifications and deployment phases, see docs/SQUADOPS_CONTEXT_HANDOFF.md*
...
*For detailed deployment phases and infrastructure roadmap, see docs/SQUADOPS_CONTEXT_HANDOFF.md*
...
**ALWAYS use `scripts/maintainer/version_cli.py` for version changes**
- ❌ NEVER manually edit `config/version.py` directly
- ✅ Framework version: `python scripts/maintainer/version_cli.py bump <version> [notes]`
- ✅ Agent version: `python scripts/maintainer/version_cli.py update <agent> <version> [notes]`
- ✅ Check version: `python scripts/maintainer/version_cli.py version` or `python scripts/maintainer/version_cli.py list`
...
- **After a plan is successfully completed and verified**, clean up temporary files:
  - **Analysis reports**: `.json` files from analysis scripts (e.g., `*_ANALYSIS_REPORT.json`, `*_REPORT.json`)
  - **Migration logs**: `.json`, `.log` files from migrations (e.g., `MIGRATION_LOG.json`, `REORGANIZATION_LOG.json`)
  - **Verification reports**: Temporary verification outputs (e.g., `VERIFICATION_REPORT.json`)
  - **Backup files**: `.backup` files after verification (e.g., `registry.yaml.backup`)
  - **Summary documents**: Temporary `.md` files documenting one-time operations (e.g., `MIGRATION_SUMMARY.md`)
- **Keep**: Permanent artifacts, registry files, actual SIP documents, production code
- **Timing**: Clean up **after plan completion and user verification**, not during active work
- **Purpose**: Maintain a clean repository and prevent clutter from temporary operational files
...
### **Session Management**
- **Read docs/SQUADOPS_CONTEXT_HANDOFF.md** for complete system overview
