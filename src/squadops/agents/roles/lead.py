"""LeadAgent - Task orchestration and delegation.
...
# Task type to skill ID mapping for Lead agent
TASK_TYPE_SKILL_MAP = {
...
class LeadAgent(BaseAgent):
    ...
    def _map_task_to_inputs(self, envelope: TaskEnvelope) -> dict[str, Any]:
        ...
        inputs["_correlation_id"] = envelope.correlation_id
