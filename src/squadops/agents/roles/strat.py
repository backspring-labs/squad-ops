"""StratAgent - Strategic planning and analysis.

The Strategy agent handles strategic planning and architecture review.
...
# Task type to skill ID mapping for Strat agent
TASK_TYPE_SKILL_MAP = {
    "strategy": "strategy_analysis",
    "analyze_strategy": "strategy_analysis",
...
class StratAgent(BaseAgent):
    """Strategy agent for planning and analysis.
