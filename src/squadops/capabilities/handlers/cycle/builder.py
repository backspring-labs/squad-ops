...
class BuilderAssembleHandler(_CycleTaskHandler):
    ...
    def _assembly_prompt_fallback(
        ...
        parts.append(
            ...
            "Your job is to add the files the build profile names in the system prompt, "
            "and none that it says the scaffold provides.\n\n"
            ...
            "- Only emit NEW files the build profile names. Never emit a file it lists as "
