"""
Unit tests for CRP schema extension with development_profile (SIP-0072 Phase 1).
"""
...
class TestAppliedDefaultsExtraKeys:
    def test_development_profile_in_extra_keys(self):
        assert "development_profile" in _APPLIED_DEFAULTS_EXTRA_KEYS
...
class TestCycleRequestProfileWithDevCapability:
    ...
    def test_development_profile_with_build_profile(self):
        profile = CycleRequestProfile(
            name="fullstack-test",
            defaults={
