...
_plugin_path = (
    Path(__file__).parents[3] / "console" / "continuum-plugins" / "squadops.system" / "__init__.py"
)
...
class TestSystemPluginRegistration:
    ...
    def test_system_infra_panel(self, mock_ctx):
        ...
        infra_panels = [c for c in panel_calls if c[0][1]["component"] == "squadops-system-infra"]
