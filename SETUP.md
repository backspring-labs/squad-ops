...
1. **Build Agent Package**:
   ...
   python scripts/build_agent.py lead
   ```
...
- **Build Script** (`scripts/build_agent.py`): Automatically resolves dependencies from `config.yaml`, assembles only required files
