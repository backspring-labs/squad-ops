...
class PromotionService:
    ...
    def __init__(
        self, memory_provider: MemoryProvider, sql_adapter: SqlAdapter, db_pool: asyncpg.Pool
    ):
        """
    ...
    async def log_memory_access(
        self, memory_id: str, agent_name: str, query_context: str | None = None
    ):
        """
    ...
    async def promote_memory(
        self, memory_id: str, validator: str, agent_name: str, auto_promote: bool = False
    ) -> str | None:
        """
        ...
        try:
            ...
            logger.info(
                f"Promoted memory {memory_id} to Squad Memory Pool as {promoted_id} (reuse: {reuse_count})"
            )
            return promoted_id
    ...
    async def get_promoted_memories(
        ...
        Args:
            ...
            cycle_id: Optional cycle ID filter (SIP-0048: renamed from ecid)
